...
class PrimaryKeyParameter(columns: Array[String]) extends Parameter[(String, String), String] {
...
class PrimaryKeyParameterBuilder extends ParameterBuilder[String, PrimaryKeyParameter] {
  ...
  override def build: PrimaryKeyParameter = new PrimaryKeyParameter(buffer.toArray)
